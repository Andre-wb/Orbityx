 ...
 */
export const formatMacro = (args, _rawArgs, _env, line, col) => {
    const template = args[0];
    if (typeof template !== 'string') {
        throw new OrbitScriptError('format!: first argument must be a string template', line, col, 'runtime');
    }
    let argIdx = 1;
...
//# sourceMappingURL=format-macro.js.map