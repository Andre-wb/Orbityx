...
export { type OSValue, type OSColor, type OSStruct, type OSEnum, type OSClosure, type ScriptMeta, type InputDef, type ScriptOutput, type PlotOutput, type HLineOutput, type BgColorOutput, type AlertOutput, type PlotShapeOutput, OrbitScriptError, } from './lang/types.js';
 ...
 */
export declare const OrbitScript: {
    readonly compile: typeof compile;
    readonly register: typeof register;
    readonly unregister: typeof unregister;
};
