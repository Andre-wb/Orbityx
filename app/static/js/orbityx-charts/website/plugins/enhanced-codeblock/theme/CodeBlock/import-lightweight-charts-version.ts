...
export type LightweightChartsApi38 = typeof import('orbityx-charts-3.8');
export type LightweightChartsApi40 = typeof import('orbityx-charts-4.0');
export type LightweightChartsApi41 = typeof import('orbityx-charts-4.1');
export type LightweightChartsApi42 = typeof import('orbityx-charts-4.2');
export type LightweightChartsApi50 = typeof import('orbityx-charts-5.0');
...
export const importLightweightChartsVersion: LightweightChartsApiGetters = {
	3.8: async (window: Window) => {
		const module = await import('orbityx-charts-3.8');
	...
	'4.0': async (window: Window) => {
		const module = await import('orbityx-charts-4.0');
	...
	4.1: async (window: Window) => {
		const module = await import('orbityx-charts-4.1');
	...
	4.2: async (window: Window) => {
		const module = await import('orbityx-charts-4.2');
	...
	'5.0': async (window: Window) => {
		const module = await import('orbityx-charts-5.0');
