...
```bash
npx esno ./tests/e2e/coverage/runner.ts ./dist/orbityx-charts.standalone.development.js
```
...
```bash
GENERATE_COVERAGE_FILE=true node ./tests/e2e/coverage/runner.js ./dist/orbityx-charts.standalone.development.js
```
...
```bash
PRODUCTION_BUILD=false DEVICE_PIXEL_RATIO=1.5 npx esno ./tests/e2e/graphics/runner.ts ./golden/orbityx-charts.standalone.development.js ./dist/orbityx-charts.standalone.development.js
```
...
```bash
npx esno ./tests/e2e/memleaks/runner.ts ./dist/orbityx-charts.standalone.development.js
```
...
```bash
npx esno ./tests/e2e/interactions/runner.ts ./dist/orbityx-charts.standalone.development.js
```
